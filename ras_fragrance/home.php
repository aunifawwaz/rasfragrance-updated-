...
$perfumes = [];
$query = "SELECT * FROM perfume WHERE perfume_id IN (11, 12, 13, 14)";
...
<body>
    ...
    <div class="price">
        RM <?= number_format($perfume['price'] ?? 0.00, 2) ?>
    </div>
</div>

            <?php endforeach; ?>
        <?php else: ?>
            <p>No perfumes available at the moment. Please check back later.</p>
        <?php endif; ?>
    </div>
</section>
