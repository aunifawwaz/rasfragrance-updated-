...
// Function to get perfume details by name with proper error handling and lowest price
        ...
        foreach ($answers as &$answer) {
            if (!empty($answer['perfume'])) {
                ...
                if ($perfumeDetails) {
                    ...
                    $answer['perfume_price'] = $perfumeDetails['display_price'];
                }
            }
        }
