...
--
-- Host: 127.0.0.1
-- Generation Time: May 15, 2025 at 12:09 AM
...
INSERT INTO `cart` (`cart_id`, `user_id`, `perfume_id`, `quantity`, `size_id`) VALUES
(37, 6, 12, 1, 0),
(38, 6, 11, 1, 0),
(39, 6, 11, 1, 0),
(40, 6, 11, 1, 0),
...
INSERT INTO `favorites` (`favorite_id`, `user_id`, `perfume_id`) VALUES
(2, 5, 16),
(3, 5, 27),
(4, 5, 12),
(5, 7, 12);
...
(39, 8, 'user_id', '7'),
(40, 9, 'email', 'auni@gmail.com'),
(41, 9, 'phone', '0182287281'),
(42, 9, 'address', 'PT 6939, Lorong Toman, Taman Setia Jaya, 45300 Sungai Besar, Selangor'),
(43, 9, 'payment_method', 'cod'),
(44, 9, 'loyalty_points_used', '0'),
(45, 9, 'subtotal', '2'),
(46, 9, 'points_discount', '0'),
(47, 9, 'user_id', '7');
...
(26, 'Coral', 1, 1.00, 'heihdohewiajcq', 'images/680fb8d6b049c.jpeg', NULL, 0, 0, 0, 'women', 0, 0, 'spring', 0, 1),
(27, 'Amber', 1, 1.00, 'This perfume is for fun and fresh women suitable to be worn on a sunny day. It opens with delicious fruit notes with mango, nectarine and blood orange follow along with the freshness of Raspberry, star apple, water lily and lotus. It then settles with a muskier scent from coconut and sandalwood. Very simple to describe for a fun and fresh scents. Definitely a collectable fragrance for everyday wear. = escada taj sunset', 'images/680fb9302c2b5.jpeg', NULL, 0, 0, 0, 'women', 0, 0, 'spring', 0, 0),
(28, 'Sapphire', 1, 1.00, 'Inspired by all the time famous strong perfume for man, Dunhill. It has a lovely fresh, sweet and woody scent coming from orange and lychee that will then settle forming a nice woody scent. Sapphire potrays a fresh aquatic with a little big hint of floral as one of its top notes. Suitable for youngster who wish to smell fresh and sweet. = dunhill desire blue', 'images/680fb97b7cefe.jpeg', NULL, 0, 0, 0, 'men', 0, 0, 'spring', 0, 0),
(29, 'Dear Vanille', 1, 1.00, 'Calling out for vanilla lovers. Dear Vanille is suitable for people who love real and warm vanilla scents. This sweet and delicious fragrance will surely bring comfort and happiness to the wearer and everyone who smells it.', 'images/680fbae5da1ca.jpeg', NULL, 0, 0, 0, 'unisex', 1, 0, 'spring', 0, 0),
(30, 'Tuberose', 1, 1.00, 'Tuberose is a fresh and elegant fragrance that blends the delicate sweetness of white floral notes with the creamy richness of tuberose. The zesty citrus adds a bright, uplifting touch, while vanilla brings warmth and depth to the composition, creating a perfect balance of lightness and sensuality.', 'images/680fbb911ea67.jpeg', NULL, 0, 0, 0, 'unisex', 0, 0, 'spring', 0, 0),
(31, 'Rose', 1, 1.00, 'hfejof', '6820d9aa8b152.jpeg', NULL, 0, 0, 0, 'unisex', 0, 1, 'spring', 1, 0);
...
(12, 'How do you usually spend your weekends?', '{\"A\":{\"text\":\"Exploring the city, going to events or meeting friends\",\"perfume\":\"\",\"next_question_id\":11},\"B\":{\"text\":\"Attending parties, night outs or dancing\",\"perfume\":\"\",\"next_question_id\":14},\"C\":{\"text\":\"Relaxing at home, reading, watching movies\",\"perfume\":\"\",\"next_question_id\":15},\"D\":{\"text\":\"Spending time in nature, hiking or outdoor activities\",\"perfume\":\"\",\"next_question_id\":16}}', 1, 3, 'branch', 11),
...
(20, 'What is your gender', '{\"A\":{\"text\":\"Male\",\"perfume\":\"\"},\"B\":{\"text\":\"Female\",\"perfume\":\"\"},\"C\":{\"text\":\"Unisex\",\"perfume\":\"\"}}', 1, 8, 'root', 21),
(21, 'What is your age range?', '{\"A\":{\"text\":\"18-24\",\"perfume\":\"\"},\"B\":{\"text\":\"25-34\",\"perfume\":\"\"},\"C\":{\"text\":\"35-44\",\"perfume\":\"\"},\"D\":{\"text\":\"45-54\",\"perfume\":\"\"},\"E\":{\"text\":\"55 and above\",\"perfume\":\"\"}}', 1, 9, 'branch', 22),
(22, 'How would you describe your personal style?', '{\"A\":{\"text\":\"Girly\",\"perfume\":\"\"},\"B\":{\"text\":\"Sporty\",\"perfume\":\"\"},\"C\":{\"text\":\"Bold\",\"perfume\":\"\"},\"D\":{\"text\":\"Trendy\",\"perfume\":\"\"}}', 1, 10, 'branch', 12);
...
--
ALTER TABLE `order_meta`
  MODIFY `meta_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=48;

--
-- AUTO_INCREMENT for table `perfume`
--
ALTER TABLE `perfume`
  MODIFY `perfume_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=32;
...
ALTER TABLE `favorites`
  ...
  ADD CONSTRAINT `favorites_ibfk_2` FOREIGN KEY (`perfume_id`) REFERENCES `perfume` (`perfume_id`) ON DELETE CASCADE;
